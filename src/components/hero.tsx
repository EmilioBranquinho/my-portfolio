    ...
    <section id="about" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="animate-fade-in-up space-y-6">
          <div>
            <p className="text-primary font-semibold text-sm mb-2">Hi, welcome to my portfolio</p>
            <h1 className="text-5xl md:text-6xl font-bold leading-tight">
              Emílio Branquinho <br />
            </h1>
            <span className="bg-gradient-to-r from-primary via-blue-500 to-primary bg-clip-text text-transparent text-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 flex-wrap">
            <button onClick={scrollToProjects} className="group bg-primary text-primary-foreground px-8 py-3 rounded-lg font-semibold flex items-center gap-2 hover:shadow-lg hover:shadow-primary/30 transition-all duration-300 transform hover:scale-105">
              View Projects
            ...
            <a
              href="/cv.pdf"
              download
              className="border border-primary text-primary px-8 py-3 rounded-lg font-semibold flex items-center gap-2 hover:bg-primary/10 transition-all duration-300 justify-center"
            >
              <Download size={18} />
              Download CV
            </a>
          ...
          <div className="flex gap-4 pt-4">
            <a
              href="#"
              className="bg-secondary hover:bg-card text-foreground p-3 rounded-full transition-all duration-300 hover:scale-110"
            >
              <Github size={20} />
            </a>
            <a
        ...
        <div className="animate-scale-in flex justify-center items-center md:justify-end">
          <div className="relative w-80 h-80 rounded-full overflow-hidden border border-border shadow-lg">
            <Image
              src={profilePic}
              alt="Perfil"
              fill
      ...
      {/* Stats */}
      <div className="grid grid-cols-3 gap-6 md:gap-8 mt-16 md:mt-20 pt-16 border-t border-border">
